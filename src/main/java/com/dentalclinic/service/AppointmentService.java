...
/**
 * Business Service handling appointment booking, 1-step inline patient registration, and overlap validation.
 * 
...
public class AppointmentService {
    ...
    /**
     * Books an appointment. Supports both Existing Patient selection AND 1-step Inline Quick-Add Patient registration.
     */
    @Transactional
    public AppointmentTicketDTO bookAppointment(BookingRequestDTO request) {
        ...
        if (request.getPatientId() != null) {
            ...
            throw new IllegalArgumentException("Either select an existing patient or provide quick-add patient details.");
        }
        ...
        Integer nextToken = appointmentRepository.countActiveAppointmentsForDentistOnDate(dentist.getDentistId(), request.getAppointmentDate()) + 1;
